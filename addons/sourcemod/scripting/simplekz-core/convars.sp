...
void CreateConVars()
{
	gCV_ChatProcessing = CreateConVar("kz_chat_processing", "1", "Whether SimpleKZ processes player chat messages.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	gCV_ConnectionMessages = CreateConVar("kz_connection_messages", "1", "Whether SimpleKZ handles connection and disconnection messages.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	gCV_DefaultStyle = CreateConVar("kz_default_style", "0", "The default movement style (0 = Standard, 1 = Legacy, 2 = Competitive).", FCVAR_NOTIFY, true, 0.0, true, 1.0);
