...
void Call_SimpleKZ_OnBeatMapRecord(int client, const char[] map, MovementStyle style, RecordType recordType, float runTime) {
...
void Call_SimpleKZ_OnBeatMapFirstTime(int client, const char[] map, MovementStyle style, RunType runType, float runTime, int rank, int maxRank) {
...
void Call_SimpleKZ_OnImproveTime(int client, const char[] map, MovementStyle style, RunType runType, float runTime, float improvement, int rank, int maxRank) {
