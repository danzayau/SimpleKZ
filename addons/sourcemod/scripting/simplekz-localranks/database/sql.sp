...
..."WHERE Times.SteamID32=%d AND MapCourses.MapID=%d AND MapCourses.Course=%d AND Times.Style=%d "
...
..."FROM Times "
..."INNER JOIN MapCourses ON MapCourses.MapCourseID=Times.MapCourseID "
..."WHERE Times.SteamID32=%d AND MapCourses.MapID=%d AND MapCourses.Course=%d AND Times.Style=%d AND Times.Teleports=0 "
..."ORDER BY Times.RunTime "
..."LIMIT %d";
...
..."INNER JOIN "
..."(SELECT MIN(Times.RunTime) AS PBTime, Times.MapCourseID, Times.Style, Times.SteamID32 "
..."FROM Times "
..."INNER JOIN MapCourses ON MapCourses.MapCourseID=Times.MapCourseID "
..."WHERE MapCourses.MapID=%d AND MapCourses.Course=%d AND Times.Style=%d "
..."GROUP BY MapCourses.MapID, MapCourses.Course, Times.Style, Times.SteamID32) PBs "
..."ON PBs.PBTime=Times.RunTime AND PBs.MapCourseID=Times.MapCourseID AND PBs.Style=Times.Style AND PBs.SteamID32=Times.SteamID32 "
..."ORDER BY Times.RunTime "
..."LIMIT %d";
...
..."INNER JOIN Players ON Players.SteamID32=Times.SteamID32 "
..."INNER JOIN "
..."(SELECT MIN(Times.TheoreticalRunTime) AS PBTime, Times.MapCourseID, Times.Style, Times.SteamID32 "
..."FROM Times "
..."INNER JOIN MapCourses ON MapCourses.MapCourseID=Times.MapCourseID "
..."WHERE MapCourses.MapID=%d AND MapCourses.Course=%d AND Times.Style=%d "
..."GROUP BY MapCourses.MapID, MapCourses.Course, Times.Style, Times.SteamID32) PBs "
..."ON PBs.PBTime=Times.TheoreticalRunTime AND PBs.MapCourseID=Times.MapCourseID AND PBs.Style=Times.Style AND PBs.SteamID32=Times.SteamID32 "
...
..."INNER JOIN MapCourses ON MapCourses.MapCourseID=Times.MapCourseID "
..."INNER JOIN Maps ON Maps.MapID=MapCourses.MapID "
..."WHERE Maps.InRankedPool=1 AND MapCourses.Course=0 AND Times.SteamID32=%d AND Times.Style=%d";
...
..."INNER JOIN MapCourses ON MapCourses.MapCourseID=Times.MapCourseID "
..."INNER JOIN Maps ON Maps.MapID=MapCourses.MapID "
..."WHERE Maps.InRankedPool=1 AND MapCourses.Course=0 AND Times.SteamID32=%d AND Times.Style=%d AND Times.Teleports=0";
